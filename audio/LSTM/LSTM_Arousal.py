...
def loadingfiles(device):
    ...
    #
    h5file = h5py.File(os.path.join(dir_path, 'my_discrete_arousal_Audio.h5'),
                       'r')
    train_arousal = {}
    for k, v in h5file.items():
...
def main(args):
    ...
    for index in range(0, movlistlength):
        ...
        # Save model
        # Model name
        model_name = movlist[index] + '_2LSTM_Arousal_Audio.pth'
        torch.save(model.state_dict(), os.path.join(args.model_path, model_name))

        # ---------------------------------------------------------------------------------------------------------------
        # save predicted arousal labels
        afilename = movlist[index] + '_predArousal_2LSTM_classification_Audio.h5'
...
if __name__ == "__main__":
    #
    dir_path = '/home/minhdanh/Documents/LSTM_Audio'   # path to extracted features and arousal files
